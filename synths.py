...
parser = ap.ArgumentParser(description = 'This program creates a synthetic .avi movie for use with DigiPyRo.')
...
parser.add_argument('-r', '--rpm', type=float, default=10.0,
                    help='The frequency of oscillations.')
parser.add_argument('-R', '--rotRate', type=float, default=0.0,
                    help='The rotation rate of the camera. The two natural frames of reference are with rotRate = and rotRate = rpm.')
parser.add_argument('--r0', type=float, default=1.0,
                    help='The initial radial position of the particle.')
parser.add_argument('--vr0', type=float, default=0.0,
                    help='The initial radial velocity of the particle.')
parser.add_argument('--phi0', type=float, default=np.pi/4,
                    help='The initial azimuthal position of the particle. Choose a value between 0 and 2*pi.')
parser.add_argument('--vphi0', type=float, default = 0,
                    help='The initial azimuthal velocity of the particle.')
